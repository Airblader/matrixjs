...
q("Vector",function(a){[].slice.call(arguments);var b=[];this.c=function(a,d){return b[d-1]};this.e=function(a,d,f){b[d-1]=f;return this};this.a=function(){return{rows:1,b:b.length}};return this});var D={stringify:{T:"\r\n",F:"\t"},l:{mode:"both"},m:{I:0},r:{which:"max"},random:{P:0,O:1,Q:k}};r.options=D;r.prototype.d=function(a,b){var c=this.constructor;if(a.j&&this.q())for(var d=0;d<a.j.length;d++)a.j[d].q()||(c=w);return new (c.bind.apply(c,[l].concat([].slice.call(arguments,1))))};
r.prototype.get=function(a,b){this.f(a,b)||e(new u(v.OUT_OF_BOUNDS));return this.c(a,b)};r.prototype.get=r.prototype.get;r.prototype.set=function(a,b,c){this.f(a,b)||e(new u(v.OUT_OF_BOUNDS));y(c)||e(new u(v.INVALID_PARAMETERS,"Value has to be a number"));return this.e(a,b,c)};r.prototype.set=r.prototype.set;r.prototype.M=function(a,b){b=E(b,m);this.f(a,l)||e(new u(v.OUT_OF_BOUNDS));return F(this,a,b)};r.prototype.getRow=r.prototype.M;
function F(a,b,c){for(var d=[],f=a.a().b,h=1;h<=f;h++)d.push(a.c(b,h));return c?a.d({},d,1):d}r.prototype.V=function(a,b){b=H(b);this.f(a,l)||e(new u(v.OUT_OF_BOUNDS));b.length!==this.a().b&&e(new u(v.INVALID_PARAMETERS,"Wrong number of columns in row."));return I(this,a,b)};r.prototype.setRow=r.prototype.V;function I(a,b,c){for(var d=a.a().b,f=1;f<=d;f++)a.e(b,f,c[f-1]);return a}r.prototype.L=function(a,b){b=E(b,m);this.f(l,a)||e(new u(v.OUT_OF_BOUNDS));return J(this,a,b)};
r.prototype.getColumn=r.prototype.L;function J(a,b,c){for(var d=[],f=a.a().rows,h=1;h<=f;h++)d.push(a.c(h,b));return c?a.d({},d,l,1):d}r.prototype.U=function(a,b){b=H(b);this.f(l,a)||e(new u(v.OUT_OF_BOUNDS));b.length!==this.a().rows&&e(new u(v.INVALID_PARAMETERS,"Wrong number of rows in column"));return K(this,a,b)};r.prototype.setColumn=r.prototype.U;function K(a,b,c){for(var d=a.a().rows,f=1;f<=d;f++)a.e(f,b,c[f-1]);return a}r.prototype.q=function(){return this instanceof C};
r.prototype.isSparse=r.prototype.q;r.prototype.i=function(){return 1===this.p("min")};r.prototype.isVector=r.prototype.i;r.prototype.h=function(){return this.a().rows===this.a().b};r.prototype.isSquare=r.prototype.h;r.prototype.N=function(){this.h()||e(new u(v.DIMENSION_MISMATCH,"Matrix must be square"));for(var a=this.a().rows,b=2;b<=a;b++)for(var c=1;c<b;c++)if(this.c(b,c)!==this.c(c,b))return m;return k};r.prototype.isSymmetric=r.prototype.N;
...
r.prototype.o=function(){var a=0,b=this.copy(),c,d,f,h,g,n=this.a().rows,t=this.a().b,z;for(f=1;f<=n;f++){d=0;g=-1;h=J(b,f,m);for(c=f;c<=n;c++)z=Math.abs(h[c-1]),z>=g&&(d=c,g=z);0===h[d-1]&&e(new u(v.MATRIX_IS_SINGULAR));d!==f&&(c=F(b,d,m),I(b,d,F(b,f,m)),I(b,f,c),a++);h=F(b,f,m);for(c=f+1;c<=n;c++){g=F(b,c,m);for(d=f;d<t;d++)g[d]-=h[d]*g[f-1]/h[f-1];g[f-1]=0;I(b,c,g)}}b.X=a;return b};r.prototype.decomposeLU=r.prototype.o;
r.prototype.H=function(){var a,b,c,d=this.a().rows;this.h()||e(new u(v.DIMENSION_MISMATCH,"Matrix must be square"));if(this.l())b=1,c=this.diag();else{try{a=this.o()}catch(f){if(f.code&&f.code===v.MATRIX_IS_SINGULAR)return 0;e(f)}b=Math.pow(-1,a.X);c=a.diag()}for(a=0;a<d;a++)b*=c[a];return b};r.prototype.det=r.prototype.H;
...
r.prototype.augment=r.prototype.n;r.prototype.J=function(a){var b=this.a().rows;(!this.i()||!a.i()||1!==this.a().b||1!==a.a().b)&&e(new u(v.INVALID_PARAMETERS,"Parameter must be a column vector"));b!==a.a().rows&&e(new u(v.DIMENSION_MISMATCH));for(var c=0,d=1;d<=b;d++)c+=this.c(d,1)*a.c(d,1);return c};r.prototype.dot=r.prototype.J;r.prototype.round=function(){return this.m(0)};r.prototype.round=r.prototype.round;
r.prototype.m=function(a){a=y(a)?a:D.m.I;var b=Math.pow(10,a);return this.g(function(a){return Math.round(a*b)/b})};r.prototype.roundTo=r.prototype.m;r.prototype.abs=function(){return this.g(function(a){return Math.abs(a)})};r.prototype.abs=r.prototype.abs;
r.prototype.G=function(a){(!this.i()||!a.i()||3!==this.a().rows||3!==a.a().rows)&&e(new u(v.INVALID_PARAMETERS,"Parameters must be three-dimensional column vectors"));return this.d({},[[this.c(2,1)*a.c(3,1)-this.c(3,1)*a.c(2,1)],[this.c(3,1)*a.c(1,1)-this.c(1,1)*a.c(3,1)],[this.c(1,1)*a.c(2,1)-this.c(2,1)*a.c(1,1)]])};r.prototype.cross=r.prototype.G;r.prototype.D=function(a){a=H(a);for(var b=this.a().rows,c=this.d({},b+1,this.a().b),d=1;d<=b;d++)I(c,d,F(this,d,m));I(c,b+1,a);return c};
r.prototype.addRow=r.prototype.D;r.prototype.C=function(a){return this.copy().n(this.d({},H(a),l,1))};r.prototype.addColumn=r.prototype.C;r.prototype.contains=function(a,b){b=y(b)?b:0;var c=this.a().rows,d=this.a().b,f;(!y(a)||!y(b))&&e(new u(v.INVALID_PARAMETERS,"Parameter must be a number"));for(var h=1;h<=c;h++){f=F(this,h,m);for(var g=0;g<d;g++)if(0===b){if(f[g]===a)return k}else if(Math.abs(f[g]-a)<=b)return k}return m};r.prototype.contains=r.prototype.contains;
r.prototype.stringify=function(a,b){a=L(a,D.stringify.T);b=L(b,D.stringify.F);for(var c=[],d,f=this.a().rows,h=1;h<=f;h++)d=F(this,h,m),c.push(d.join(b));return c.join(a)};r.prototype.stringify=r.prototype.stringify;r.prototype.K=function(a){var b=this.a().rows,c=this.a().b,d,f;if(b!==a.a().rows||c!==a.a().b)return m;for(var h=1;h<=b;h++){d=F(this,h,m);f=F(a,h,m);for(var g=0;g<c;g++)if(d[g]!==f[g])return m}return k};r.prototype.equals=r.prototype.K;
r.prototype.g=function(a,b){b=b||O.all;"function"!==typeof a&&e(new u(v.INVALID_PARAMETERS,"Applicator must be a function"));"function"!==typeof b&&e(new u(v.INVALID_PARAMETERS,"Filter must be a function"));var c,d;c=this.a();for(var f=c.rows,h=c.b,g=this.d({},f,h),n=1;n<=f;n++){d=F(this,n,m);for(var t=1;t<=h;t++)c=d[t-1],b(c,n,t)&&(d[t-1]=a(c,n,t));I(g,n,d)}return g};r.prototype.fun=r.prototype.g;r.prototype.W=function(a){return this.g(a,O.nonZero)};r.prototype.spfun=r.prototype.W;
r.prototype.R=function(){return this.g(P.exp,l)};r.prototype.pw_exp=r.prototype.R;r.prototype.S=function(a){return this.g(function(b){return Math.pow(b,a)},l)};r.prototype.pw_pow=r.prototype.S;
