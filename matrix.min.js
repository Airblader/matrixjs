function e(a){throw a;}var k=!0,l=null,m=!1,p=this;Math.random();function q(a,b){var c=a.split("."),d=p;!(c[0]in d)&&d.execScript&&d.execScript("var "+c[0]);for(var f;c.length&&(f=c.shift());)!c.length&&void 0!==b?d[f]=b:d=d[f]?d[f]:d[f]={}};Object.create=Object.create||function(a){function b(){}b.prototype=a;return new b};function r(){this.constructor=l;this.b=function(){return l};this.d=function(){return this};this.a=function(){return{rows:l,c:l}};e(Error("MatrixCommon cannot be instantiated"))}q("MatrixCommon",r);function t(){e(Error("This cannot be instantiated"))}q("MatrixUtils",t);
