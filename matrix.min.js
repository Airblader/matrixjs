function e(a){throw a;}var k=!0,l=null,m=!1,p=this;Math.random();function q(a,b){var c=a.split("."),d=p;!(c[0]in d)&&d.execScript&&d.execScript("var "+c[0]);for(var f;c.length&&(f=c.shift());)!c.length&&void 0!==b?d[f]=b:d=d[f]?d[f]:d[f]={}};function r(){var a=window.console&&window.console.log||{log:function(){}};this.b=function(b,c){a.log("Tried to call MatrixCommon::___get("+b+", "+c+")");return l};this.d=function(b,c,d){a.log("Tried to call MatrixCommon::___set("+b+", "+c+", "+d+")");return this};this.a=function(){a.log("Tried to call MatrixCommon::___dim()");return{rows:-1,c:-1}};e(Error("MatrixCommon cannot be instantiated"))}q("MatrixCommon",r);function t(){e(Error("This cannot be instantiated"))}q("MatrixUtils",t);
