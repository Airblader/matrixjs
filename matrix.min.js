...
r.prototype.diag=r.prototype.diag;r.prototype.f=function(a,b){return(!y(a)||1<=a&&a<=this.a().rows)&&(!y(b)||1<=b&&b<=this.a().b)};r.prototype.isInRange=r.prototype.f;w.zeros=function(a,b){b=y(b)?b:a;return new w(a,b)};w.ones=function(a,b){b=y(b)?b:a;for(var c=new w(a,b),d=1;d<=a;d++)for(var f=1;f<=b;f++)c.e(d,f,1);return c};function N(a){for(var b=new w(a,a),c=1;c<=a;c++)b.e(c,c,1);return b}w.eye=N;
w.diag=function(a,b){a=H(a);b=y(b)?b:0;for(var c=new w(a.length+Math.abs(b)),d=-Math.min(b,0),f=Math.max(b,0),h=c.a().rows-Math.abs(b),g=1;g<=h;g++)c.e(g+d,g+f,a[g-1]);return c};w.diag=w.diag;w.random=function(a,b,c,d,f){b=y(b)?b:a;c=y(c)?c:D.random.O;d=y(d)?d:D.random.N;f=E(f,D.random.P);var h=new w(a,b);d=d-c+(f?1:0);for(var g,n=1;n<=a;n++)for(var t=1;t<=b;t++)g=c+Math.random()*d,f&&(g|=0),h.e(n,t,g);return h};function y(a){return"number"===typeof a}function A(a){return y(a)&&(a|0)===a}
function x(a){for(var b=0;b<a.length;b++)if(!y(a[b]))return m;return k}s.linspace=function(a,b,c){c=y(c)?c:1;for(var d=[];a<=b;a+=c)d.push(a);return d};function B(a,b){for(var c=[],d=1;d<=a;d++)c[d-1]=b;return c}s.repeat=B;function H(a){if(!(a instanceof r))return a;a.i()||e(new u(v.DIMENSION_MISMATCH,"Argument has to be vector"));var b=a.copy();a.p("max")!==a.a().rows&&(b=b.A());a=[];for(var c=b.a().rows,d=1;d<=c;d++)a.push(b.c(d,1));return a}function L(a,b){return"string"===typeof a?a:b}
function E(a,b){return"boolean"===typeof a?a:b}var O={all:function(){return k},nonZero:function(a){return 0!==a},diag:function(a,b,c){return b===c}};s.filters=O;var P={exp:function(a){return Math.exp(a)},square:function(a){return a*a}};s.applicators=P;Array.prototype.t=function(a,b){return new w(this,a,b)};q("Array.prototype.toMatrix",Array.prototype.t);Array.prototype.X=function(a){a=E(a,m);return new w(this,a?1:this.length,a?this.length:1)};q("Array.prototype.toVector",Array.prototype.X);
